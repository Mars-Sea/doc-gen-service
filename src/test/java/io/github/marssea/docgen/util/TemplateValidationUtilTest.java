...
class TemplateValidationUtilTest {
    ...
    class ValidateTemplateNameTest {
        ...
        void shouldPassValidationForValidTemplateName() {
            assertDoesNotThrow(
                    () -> TemplateValidationUtil.validateTemplateName("valid-template.docx"));
            assertDoesNotThrow(
                    () -> TemplateValidationUtil.validateTemplateName("report_2024.xlsx"));
    ...
    class ValidateWordTemplateExtensionTest {
        ...
        void shouldPassValidationForDocxExtension() {
            assertDoesNotThrow(
                    () -> TemplateValidationUtil.validateWordTemplateExtension("template.docx"));
            assertDoesNotThrow(
                    () -> TemplateValidationUtil.validateWordTemplateExtension("TEMPLATE.DOCX"));
        }
    ...
    class ValidateExcelTemplateExtensionTest {
        ...
        void shouldPassValidationForXlsxExtension() {
            assertDoesNotThrow(
                    () -> TemplateValidationUtil.validateExcelTemplateExtension("template.xlsx"));
            assertDoesNotThrow(
                    () -> TemplateValidationUtil.validateExcelTemplateExtension("TEMPLATE.XLSX"));
        }
        ...
        void shouldPassValidationForXlsExtension() {
            assertDoesNotThrow(
                    () -> TemplateValidationUtil.validateExcelTemplateExtension("template.xls"));
            assertDoesNotThrow(
                    () -> TemplateValidationUtil.validateExcelTemplateExtension("TEMPLATE.XLS"));
        }
        ...
        void shouldThrowExceptionForNonExcelExtension(String templateName) {
            IllegalArgumentException exception =
                    assertThrows(
                            IllegalArgumentException.class,
                            () ->
                                    TemplateValidationUtil.validateExcelTemplateExtension(
                                            templateName));
